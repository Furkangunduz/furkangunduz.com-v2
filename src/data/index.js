...
export const projectsCardInfos = [
    {
        ...
        description: 'This is the project which can help you find train tickets when all train tickets for all train trips are bought. This project uses   <strong>Express </strong> and <strong>Puppeteer </strong> to get informationabout train trips on the server side. When you create a request to the server, it starts the search for a train ticket for you. When it finds it, it sends the email to you. On the Client side Front-end made by using <strong>React</strong> and <strong>TailwindCSS </strong> .',
